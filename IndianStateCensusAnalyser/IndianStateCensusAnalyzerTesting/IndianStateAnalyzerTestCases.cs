...
namespace IndianStateCensusAnalyzerTesting
{
    ...
    {
        string stateCensusFilePath = @"C:\Users\rajar\source\repos\IndianStateCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\IndianPopulation.csv";
        string wrongFilePath = @"C:\Users\rajar\source\repos\IndianStateCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\WrongIndianPopulation.csv";
        string wrongTypeFilePath = @"C:\Users\rajar\source\repos\IndianStateCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\IndiaStateCode.txt";
        string wrongDelimiterFilePath = @"C:\Users\rajar\source\repos\IndianStateCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\DelimiterIndiaStateCensusData.csv";
        string wrongHeaderFilePath = @"C:\Users\rajar\source\repos\IndianStateCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\WrongIndiaStateCensusData.csv";
